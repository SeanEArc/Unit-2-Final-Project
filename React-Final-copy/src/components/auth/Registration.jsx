    ...
    <div className="max-w-6xl mx-auto p-6 text-center">
      ...
      <hr className='mx-10 my-5 bg-gray-300 border-0.5'/>
        ...
        <div className='mt-10 mx-20'>
          ...
          <button type="submit" className='mt-2 px-4 py-2 bg-green-500 text-white shadow-md rounded hover:cursor-pointer hover:bg-blue-600 hover:scale-101'>Register</button>
